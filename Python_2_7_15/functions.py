...
# For every sorting procedure, it uses the sorted function from python which uses the timsort algorithm which is a combination of binary insertion sort and merge sort and therefore decides depending on the size of the dictionary which algorithm to choose. (Python Software Foundation, 06/20)
